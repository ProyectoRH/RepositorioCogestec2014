        ...
        {% for item, item_perms in paginated_items.object_list %}
            ...
            <tr class="{% cycle rowcolors %}">
                ...
                <td style="text-align: right;">
                    <input type="submit" name="move-to-clipboard-{{ file.id|unlocalize }}" value="&rarr;" title="{% trans "Move to clipboard" %}"{% if file in çclipboard_files or not item_perms.change %} style="color: gray;" disabled="disabled"{% endif %} />
                </td>
            </tr>
            {% endwith %}{% endif %}
        {% endfor %}
