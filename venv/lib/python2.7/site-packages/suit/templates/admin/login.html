...
{% block container %}
    ...
    {% block content %}
        ...
        {% if form.non_field_errors or form.this_is_the_login_form.errors %}
            ...
            {% endfor %}
        {% endif %}
        <div style="position:absolute;top:0;left:0;width:100%;background-color:wheat;padding:6px;">Para el usuario y contrasena, utiliza <b>cogestec2014</b></div>
        <div id="content-main">
            <img src="http://104.236.142.130:8000/media/filer_public/14/6e/146ef58a-7e76-4a7d-8a11-a815c90e7b63/logo_05.png" style="display:block;margin:0 auto;" width="70%">
            ...
            <script type="text/javascript">
                ...
                document.getElementById('id_username').value = "cogestec2014";
                document.getElementById('id_password').value = "cogestec2014";
            </script>
        </div>
    {% endblock %}
{% endblock %}
