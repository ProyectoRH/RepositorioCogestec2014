...
.left-nav>ul>li.active>a{color:#fff;text-shadow:0 1px #D59423;background-color:rgb(255, 102, 0);background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, left bottom, from(rgb(255, 180, 108)), to(rgb(255, 117, 0)));background-image:-webkit-linear-gradient(rgb(255, 180, 108), rgb(255, 117, 0));background-image:-moz-linear-gradient(rgb(255, 180, 108), rgb(255, 117, 0));background-image:-o-linear-gradient(top, rgb(255, 180, 108), rgb(255, 117, 0));background-image:-khtml-gradient(linear, left top, left bottom, from(rgb(255, 180, 108)), to(rgb(255, 117, 0)));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='rgb(255, 180, 108)', EndColorStr='rgb(255, 117, 0)', GradientType=0);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='rgb(255, 180, 108)', EndColorStr='rgb(255, 117, 0)', GradientType=0))";border-bottom-color:#ccc}.left-nav>ul>li.active>a i{background-image:url(../img/glyphicons-halflings-white-shadow.png);opacity:1}
.left-nav>ul>li.active>a:after{content:url('../mg/cc_active_nav.png');display:inline-block;margin-right:-21px;float:right;margin-top:-5px}
